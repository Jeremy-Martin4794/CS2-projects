...
int main() {
...

	{
		...
		// Setup fixture
		bigint left("1");
		bigint right("555555555555555555555555555555");
		bigint result;
		...
		// Verify
		assert(left == "1");
		assert(right == "555555555555555555555555555555");
		assert(result == "555555555555555555555555555555");
	}
...

	{
		...
		// Setup fixture
		bigint left("2");
		bigint right("3000000000000000000000000000");
		bigint result;
		...
		// Verify
		assert(left == "2");
		assert(right == "3000000000000000000000000000");
		assert(result == "6000000000000000000000000000");
	}
	
	{
		...
		// Setup fixture
		bigint left("0");
		bigint right("99999999999999999999999999");
		bigint result;
		...
		// Verify
		assert(left == "0");
		assert(right == "99999999999999999999999999");
		assert(result == "0");
	}
